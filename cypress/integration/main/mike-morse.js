...
describe('CP Direct home', () => {
  it('successfully loads', () => {
    cy.visit('https://cp-intake.herokuapp.com/mm/') 
  })
})
...
describe('Successfully login', () => {
  it('Credentials entered + validated + redirects to case dashboard', () => {
    cy.get('input[name=userName]').type('sylvie+persona3@graveflex.com')
...
describe('Select CONTACT US in nav', () => {
  it('TEST SCENERIO 2.7', () => {
   ...
   // TEST CONTACT FORM 
    ...
    cy.get('textarea[name=textBody]').type('automated test run Mike Morse')
